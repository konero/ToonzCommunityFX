...
vec3 layerBlendingAlgorithm(vec3 base, vec3 top) {
    ...
    return vec3(
        (top.r < 0.5) ? 
            (2.0 * base.r * top.r + base.r * base.r * (1.0 - 2.0 * top.r)) :
            (2.0 * base.r * (1.0 - top.r) + sqrt(base.r) * (2.0 * top.r - 1.0)),
        (top.g < 0.5) ? 
            (2.0 * base.g * top.g + base.g * base.g * (1.0 - 2.0 * top.g)) :
            (2.0 * base.g * (1.0 - top.g) + sqrt(base.g) * (2.0 * top.g - 1.0)),
        (top.b < 0.5) ? 
            (2.0 * base.b * top.b + base.b * base.b * (1.0 - 2.0 * top.b)) :
            (2.0 * base.b * (1.0 - top.b) + sqrt(base.b) * (2.0 * top.b - 1.0))
    );
}
